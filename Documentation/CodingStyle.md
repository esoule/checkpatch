...
>        **new** code to fit 80 columns, fix mixing of tabs and
...
> **Our note:**
>
> Reviewers are free to ask developers to make their **new** code
...
> **Our note:**
>
> NOTE: Our reviewers ask developers to **always** use braces, for
...
> file for spacing errors, **before** submitting your code for
> review.
>
...
> **Our note:**
>
> NOTE: Reviewers ask developers to include **measurement**
> **units** into variable names, function argument names and
...
> **above**) applies to the in-tree kernel code.
>
> For out-of-tree networking code (e.g. kernel modules), you
> are free to use the general comment style shown **above** it.
>
...
> **Our note:**
>
> NOTE: macros **must** be subject to **peer review**,
...
> ask you to provide a numerical **proof** that this
> **significantly** speeds up the execution of your program.
>
...
>
> In userspace C, in functions that return pointers, it
...
>
> Note that some of the C library functions are **deprecated**,
> do not have **context** parameter (in other words, are not
...
However, **avoid** using casts when fixing compiler warnings:
...
Below is an **incomplete** list of ifdef anti-pattern examples:
